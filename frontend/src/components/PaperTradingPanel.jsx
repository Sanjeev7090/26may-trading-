...
// ---- Stat Card ----
const StatCard = ({ label, value, sub, color = 'white', testId }) => (
...
const PaperTradingPanel = ({ selectedStock, pendingTrade, onPendingTradeConsumed, autoExecute, onAutoExecuteChange }) => {
  ...
  const handleReset = async () => {
    if (!window.confirm('Portfolio ko ₹5,00,000 par reset karna chahte ho? Sabhi trades delete ho jayenge.')) return;
    setResetting(true);
    try {
